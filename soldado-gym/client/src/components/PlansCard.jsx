...
export const Plans = ({ name, amount, description, n_class }) => {
  ...
  return (
    <div className=" flex min-h-96 gap-10 lg:min-h-96 justify-between items-center relative text-white py-7 lg:py-16 px-6 rounded-md bg-[#1C1C1C] flex-col">
      <img
      ...
      <div>
        ...
        <div className="flex flex-col justify-center items-center font-semibold">
          ...
          <span className="w-60 text-[15px] md:text-sm lg:min-h-52 md:w-72 mt-10">{description}</span>
        </div>
      </div>
      <div className="">
