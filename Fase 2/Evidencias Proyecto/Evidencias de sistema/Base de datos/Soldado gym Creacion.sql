...
-- Started on 2024-10-17 13:51:40
...
COPY public.nutrition (id, name, description, price) FROM stdin;
\.
...
COPY public.plans (plan_id, name, description, price, n_class, type) FROM stdin;
\.
...
-- Completed on 2024-10-17 13:51:41
